...
struct Constants {
    ...
    /// Identifier
    struct Id {
        static let Group = "group.ckt.dev.app.OpenInTerminal"
        static let OpenInTerminalLite = "ckt.dev.app.OpenInTerminal-Lite"
        static let OpenInEditorLite = "ckt.dev.app.OpenInEditor-Lite"
